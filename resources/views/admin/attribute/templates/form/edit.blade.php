{!! Form::open([
    'url' => route('admin.attribute.update', $attribute),
                                    ...
                                    <div class="col-xl-6">
                                        <select class="form-control" data-toggle="select"
                                            ...
                                            @foreach ($attributeSet as $set)
                                                <option {{ $attribute->attribute_set_id != $set->id ?: 'selected' }}
                                                    value="{{ $set->id }}">
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-group">
                                            {!! Form::text('name', $attribute->translation()->name, ['class' => 'form-control', 'required' => true]) !!}
                        ...
                        <div class="card border m-0 shadow-none">
                            ...
                            <div class="card-body">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::text('slug', $attribute->slug, ['class' => 'form-control', 'required' => true]) !!}
                                        @error('slug')
                                            <div class="error-feedback d-block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group form-row">
                                    {!! Form::hidden('meta[id]', $attribute->meta ? $attribute->meta->id : null) !!}
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::text('meta[translation][title]', $attribute->meta ? $attribute->meta->translation()->title : null, ['class' => 'form-control']) !!}
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::textarea('meta[translation][description]', $attribute->meta ? $attribute->meta->translation()->description : null, ['class' => 'form-control']) !!}
