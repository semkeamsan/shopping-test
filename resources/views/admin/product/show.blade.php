                                            ...
                                            <div class="d-flex justify-content-between pt-1">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div class="text-sm font-weight-bold">
                                                        ...
                                                        {{ $product->created_at ? $product->created_at->diffForHumans() : null }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex justify-content-between pt-1">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div class="text-sm font-weight-bold">
                                                        ...
                                                        {{ $product->updated_at ? $product->updated_at->diffForHumans() : null }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="float-right">
                            <a class="btn btn-outline-primary"
                                href="{{ route('admin.product.edit', $product) }}">{{ __('Edit') }}</a>
                        </div>
                    </div>
                </div>
            </div>
