<div id="attributes" class="tab-pane fade">
    <div class="card border m-0 shadow-none">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody data-toggle="ui-drag" id="clone-attributes">
                        ...
                        <tr class="bg-white d-none border" id="clone-attribute">
                            ...
                            <td>
                                <select class="form-control" id="attribute" data-name="attributes[{0}][attribute_id]"
                                    data-placeholder="{{ __('Please Select') }}" data-target="#attribute-value-{0}">
            ...
            <button data-toggle="clone" data-clone="#clone-attribute" data-target="#clone-attributes" type="button"
