<div id="images" class="tab-pane fade">
    <div class="card border m-0 shadow-none">
        ...
        <div class="card-body d-none">
            ...
            <br>
            <button type="button" class="btn btn-secondary mb-3" id="fimage" data-target-input="#feature"
                data-target-image="#im-image">
        ...
        <div class="card-body border-top">
            ...
            <br> --}}
            <button type="button" class="btn btn-secondary mb-3" id="fimages" data-target="#im-images">
                <i class="fal fa-folder-open"></i>
                {{ __('Browse') }}
            </button>
            <div data-toggle="ui-drag" class="p-2 border" id="im-images"
                style="min-height: 230px; max-height: 100%">
                @include('admin.product.templates.form.oldvalues.image',['images' => old('images',$product->images)])
