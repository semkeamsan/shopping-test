    ...
    <div class="card border m-0 shadow-none">
        ...
        <div class="card-body">
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::number('price', $product->price, ['class' => 'form-control', 'required' => true]) !!}
                    @error('price')
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::number('special_price', $product->special_price, ['class' => 'form-control']) !!}
                    @error('special_price')
                        <div class="error-feedback d-block">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select class="form-control" data-toggle="select" name="special_price_type">
                        <option {{ old('special_price_type', $product->special_price_type) != 'fixed' ?: 'selected' }}
                            value="fixed">{{ __('Fixed') }}</option>
                        <option
                            {{ old('special_price_type', $product->special_price_type) != 'percent' ?: 'selected' }}
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::text('special_price_start', $product->special_price_start, ['class' => 'form-control datepicker']) !!}
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::text('special_price_end', $product->special_price_end, ['class' => 'form-control datepicker']) !!}
