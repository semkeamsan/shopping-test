    ...
    <div class="card border m-0 shadow-none">
        ...
        <div class="card-body">
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::text('slug', $product->slug, ['class' => 'form-control', 'required' => true]) !!}
                    @error('slug')
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::hidden('meta[id]', $product->meta ? $product->meta->id : null) !!}
                    {!! Form::hidden('meta[translation][locale]', app()->getLocale()) !!}
                    {!! Form::text('meta[translation][title]', $product->meta ? $product->meta->translation()->title : null, ['class' => 'form-control']) !!}
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    {!! Form::textarea('meta[translation][description]', $product->meta ? $product->meta->translation()->description : null, ['class' => 'form-control']) !!}
