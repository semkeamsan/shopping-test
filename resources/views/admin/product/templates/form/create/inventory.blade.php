            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select class="form-control" data-toggle="select" name="manage_stock">
                        <option {{ old('manage_stock') != 0 ?:'selected' }} value="0">{{ __('Don\'t Track Inventory') }}</option>
                        <option {{  old('manage_stock') != 1 ?:'selected' }} value="1">{{ __('Track Inventory') }}</option>
                    </select>
                    @error('manage_stock')
                        <div class="error-feedback d-block">
                            {{ $message }}
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select class="form-control" data-toggle="select" name="in_stock">
                        <option {{ old('in_stock') != 1 ?:'selected' }} value="1">{{ __('In Stock') }}</option>
                        <option {{ old('in_stock') != 0 ?:'selected' }} value="0">{{ __('Out of Stock') }}</option>
                    </select>
                    @error('in_stock')
                        <div class="error-feedback d-block">
                            {{ $message }}
