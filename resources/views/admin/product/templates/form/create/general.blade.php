    ...
    <div class="card border m-0 shadow-none">
        ...
        <div class="card-body">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-9">
                    <div id="container-description">
                        <div data-toggle="quill" data-quill-placeholder="" data-target="#description">{!! old('description') !!}</div>
                        {!! Form::label('description', null, ['class' => 'd-none']) !!}
                        {!! Form::textarea('description', null, ['class' => 'form-control d-none', 'required' => true])!!}
                        @error('description')
                        <div class="error-feedback d-block">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select multiple class="form-control" data-toggle="select" name="categories[]">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select class="form-control" data-toggle="select" name="tax_class_id">
                        ...
                        <option {{ old('brand_id') !=$brand->id ?: 'selected' }} value="{{ $tax->id }}">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <select multiple class="form-control" data-toggle="select" name="tags[]">
                        @foreach ($tags as $tag)
                        <option {{ !in_array($tag->id, old('tags', [])) ?: 'selected' }} value="{{ $tag->id }}">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="virtual" name="virtual" value="1" {{ old('virtual') !=1 ?: 'checked' }}>
                        <label class="custom-control-label" for="virtual">{{ __('The product won\'t be shipped')
                            }}</label>
                    </div>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-xl-6">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="is_active">{{ __('Enable the product') }}</label>
                    </div>
