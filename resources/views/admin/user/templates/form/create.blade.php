    ...
    <div class="card-body">
        <div class="form-row">
            <div class="col-xl-8">
                <div class="form-row">
                    <div class="col-xl-6 mb-3">
                        ...
                        {!! Form::text('name', null, ['class' => 'form-control', 'live-input', 'data-target' => '#show-name', 'data-text' => __('Name'), 'required' => true]) !!}
                        @error('name')
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-control h-auto">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="female" value="female" name="gender"
                                            {{ old('gender') == 'female' ? 'checked' : null }}
                                            class="custom-control-input">
                            ...
                            <div class="col-xl-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('dob', null, ['class' => 'form-control datepicker', 'required' => true]) !!}
                                    @error('dob')
                                        <div class="error-feedback d-block">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" data-toggle="select" live-input data-target="#show-role"
                                data-text="{{ __('Role') }}"  name="role_id"
                                 required>
            ...
            <div class="col-xl-4">
                ...
                {!! Form::hidden('avatar', old('avatar', asset('images/avatar.png')), ['class' => 'custom-file-input']) !!}

                <div class="card">
                    <div class="card-body">
                        <a href="#" id="image" data-target-input="#avatar" data-target-image="#im-avatar">
                            <img src="{{ old('avatar', asset('images/avatar.png')) }}" id="im-avatar"
                                class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                style="height: 140px;width: 140px;">
                        </a>
                        <div class="pt-4 text-center">
                            <h5 class="h3 title">
                                <span class="d-block mb-1" id="show-name">{{ __('Name') }}</span>
                                <small class="h4 font-weight-light text-muted"
                                    id="show-role">{{ __('Role') }}</small>
                            </h5>
                            <div class="mt-3">
