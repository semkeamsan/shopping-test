{!! Form::open([
    'url' => route('admin.brand.update',$brand),
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-group">
                                            {!! Form::text('name', $brand->translation()->name, ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div id="images" class="tab-pane fade">
                        <div class="card border m-0 shadow-none">
                            ...
                            <div class="card-body">
                                ...
                                {!! Form::hidden('logo', old('logo', $brand->logo), ['class' => 'custom-file-input']) !!}
                                <br>
                                ...
                                <div class="col p-3 border" style="width:135px;height: 135px;">
                                    <div class="avatar rounded bg-transparent" style="width:100px;height: 100px;">
                                        <img id="im-image" src="{{  $brand->logo ?? asset('images/default.png') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border m-0 shadow-none">
                            ...
                            <div class="card-body">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::text('slug', $brand->slug, ['class' => 'form-control', 'required' => true]) !!}
                                        @error('slug')
                                            <div class="error-feedback d-block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group form-row">
                                    {!! Form::hidden('meta[id]', $brand->meta ? $brand->meta->id : null) !!}
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::text('meta[translation][title]', $brand->meta ? $brand->meta->translation()->title : null, ['class' => 'form-control']) !!}
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-xl-6">
                                        {!! Form::textarea('meta[translation][description]', $brand->meta ? $brand->meta->translation()->description : null, ['class' => 'form-control']) !!}
