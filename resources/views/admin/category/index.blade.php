    ...
    <div class="row">
        <div class="col">
            <div class="card-wrapper">
                <div class="card">
                    <div class="card-header {{ config('page.permissions')->contains('create-store') ?: 'd-none' }}">
                        <div class="form-row">
                            <div class="col-auto col-xl-6">
                                <a id="create" class="btn btn-outline-primary" href="{{ route('admin.category.create') }}">
                                    {{ __('Create') }}
                                </a>
                            </div>
                        </div>
                    ...
                    {{-- <div class="table-responsive py-4">
                        @include('admin.category.templates.table')
                    </div> --}}
                </div>
            </div>
        </div>
