        ...
        var s = function(t) {
            function e() {
                ...
                for (var s = arguments.length, u = Array(s), c = 0; c < s; c++)
                    u[c] = arguments[c];
                return n = i = r(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(u))),
                i.onCreate = function() {
                ...
                i.onUpdate = function() {
                    if (i.display && i.img) {
                        ...
                        if (i.display.innerHTML = t.join(" &times; "),
                        t[0] > 120 && t[1] > 30)
                ...
                i._addToolbarButtons = function() {
                    ...
                    i.alignments.forEach(function(e, n) {
                        ...
                        o.addEventListener("click", function() {
                            ...
                            e.isApplied() ? (h.remove(i.img),
                            y.remove(i.img),
                            v.remove(i.img)) : (i._selectButton(o),
                            e.apply()),
                            i.requestUpdate()
                        }),
        ...
        var r = n(37)
          ...
          , f = function t(e) {
            ...
            this.hideOverlay = function() {
                n.overlay && (n.quill.root.parentNode.removeChild(n.overlay),
                n.overlay = void 0,
            ...
            this.checkImage = function(t) {
                n.img && (46 != t.keyCode && 8 != t.keyCode || window.Quill.find(n.img).deleteAt(0),
                n.hide())
            }
            ,
            this.quill = e;
        ...
        function o(t, e, n, o, g, x, m) {
            ...
            if (S) {
                var E = l(j)
                  ...
                  , z = !E && !A && v(j);
                O = j,
                E || A || z ? l(_) ? O = _ : f(_) ? O = s(_) : A ? (S = !1,
                O = i(j, !0)) : z ? (S = !1,
                O = a(j, !0)) : O = [] : y(j) || c(j) ? (O = _,
                c(_) ? O = b(_) : (!h(_) || o && d(_)) && (O = u(j))) : S = !1
            }
            S && (m.set(j, O),
            g(O, j, o, x, m),
            m.delete(j)),
